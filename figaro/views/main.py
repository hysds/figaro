...
from figaro import app, db, lm
from figaro.lib.job_utils import get_execute_nodes
from figaro.models.user import User
from figaro.lib.forms import LoginForm
from figaro.lib.ldap import ldap_user_verified
...
def index():
    ...
    now = datetime.utcnow()
    return render_template('figaro.html',
                           title='HySDS Resource Management',
